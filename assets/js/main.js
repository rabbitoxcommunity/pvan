...
(function() {
   ...
   * Mobile nav toggle
   */
  const mobileNavToggleBtnMenu = document.querySelector('.menu-icon');
  const mobileNavToggleBtnClose = document.querySelector('.close-icon');
  
  function mobileNavToogle() {
      document.querySelector('body').classList.toggle('mobile-nav-active');
      
      // Toggle visibility of the menu and close icons
      if (mobileNavToggleBtnMenu.style.display === 'none') {
          mobileNavToggleBtnMenu.style.display = 'block';
          mobileNavToggleBtnClose.style.display = 'none';
      } else {
          mobileNavToggleBtnMenu.style.display = 'none';
          mobileNavToggleBtnClose.style.display = 'block';
      }
  }
  
  // Add event listeners for both images
  mobileNavToggleBtnMenu.addEventListener('click', mobileNavToogle);
  mobileNavToggleBtnClose.addEventListener('click', mobileNavToogle);
